...
export const ADMIN_ROUTE_PERMISSION_RULES: readonly RoutePermissionRule[] = [
  ...
  },
  {
    ...
    accessMode: 'staff_protected',
    allowedRoles: REVIEW_STAFF_ROLES,
    requiredPermissions: ['verification_reviews:view'],
    isSidebarEligible: true,
  },
  {
    pathPattern: '/verification/[verificationType]',
  ...
  {
    pathPattern: '/transaction-cases',
    label: 'Transaction Cases',
    accessMode: 'staff_protected',
    allowedRoles: REVIEW_STAFF_ROLES,
    requiredPermissions: ['transaction_cases:view'],
    isSidebarEligible: true,
  },
  {
