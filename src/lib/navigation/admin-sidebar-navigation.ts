...
export const ADMIN_SIDEBAR_NAVIGATION: readonly AdminNavigationItem[] = [
  ...
  },
  {
    ...
    description: 'Manage manual verification workload and customer queries.',
    badgeKey: 'verificationAttentionCount',
    allowedRoles: ['admin'],
    ...
    children: [
      {
        ...
        href: '/verification',
        iconName: 'LayoutDashboard',
        description: 'View verification workload and attention summaries.',
        allowedRoles: ['admin'],
      },
      {
        label: 'Onboarding',
        ...
        iconName: 'ClipboardCheck',
        description: 'Review onboarding verification records.',
        allowedRoles: ['admin'],
      },
      {
        label: 'Properties',
        href: '/verification/properties',
        iconName: 'House',
        description: 'Review property verification records.',
        allowedRoles: ['admin'],
      },
      {
        label: 'Payments',
        href: '/verification/payments',
        iconName: 'CreditCard',
        description: 'Review payment verification records.',
        allowedRoles: ['admin'],
      },
      {
        label: 'API Partners',
        href: '/verification/api-partners',
        iconName: 'KeyRound',
        description: 'Review API partner verification records.',
        allowedRoles: ['admin'],
      },
      {
        label: 'Property Transactions',
        href: '/verification/property-transactions',
        iconName: 'Workflow',
        description: 'Review transaction verification records.',
        allowedRoles: ['admin'],
      },
      {
        label: 'Queries',
        href: '/verification/queries',
        iconName: 'MessageCircleQuestion',
        description: 'Manage verification queries requiring attention.',
        badgeKey: 'verificationAttentionCount',
        allowedRoles: ['admin'],
      },
    ],
    ...
    children: [
      {
        ...
        href: '/support',
        iconName: 'Headphones',
        description: 'Manage support cases, assignment, escalation, and resolution.',
        badgeKey: 'supportAttentionCount',
        allowedRoles: ['admin'],
      },
      {
        label: 'Transaction Cases',
        href: '/transaction-cases',
        iconName: 'Workflow',
        description: 'Coordinate property transaction progression.',
        badgeKey: 'transactionCaseAttentionCount',
        allowedRoles: ['admin'],
      },
      {
