...
export default function PropertyOwnerProfilesPage() {
  ...
  return (
    <ManagementListPage
      ...
      filters={[{ label: 'All profiles', href: '/profiles' }, { label: 'Under review', href: '/profiles/property-owners?status=under_review' }, { label: 'Approved', href: '/profiles/property-owners?status=approved' }]}
      metrics={[
        { label: 'Owner profiles', value: String(profiles.length), detail: 'Demo property owner records', tone: 'info' },
        { label: 'Approved', value: '0', detail: 'Ready for property workflows', tone: 'success' },
        { label: 'In review', value: '1', detail: 'Verification currently active', tone: 'warning' },
        { label: 'Document attention', value: '1', detail: 'Related records need review', tone: 'danger' },
      ]}
