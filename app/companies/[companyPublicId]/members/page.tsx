...
} from '../../../../src/features/companies/constants/companies.constants';
                ...
                {company.members.map((member) => (
                  <tr key={member.memberPublicId}>
                    <td>
                      ...
                      <br />
                      <span>
                        {member.emailLabel} - {member.userPublicId}
                      </span>
                    </td>
                    <td>
                      <Badge tone="neutral">{COMPANY_MEMBER_ROLE_LABELS[member.role]}</Badge>
                    </td>
                    <td>
                      <Badge
                        tone={
                      ...
                      >
                        {COMPANY_MEMBER_STATUS_LABELS[member.status]}
                      </Badge>
                    </td>
                    <td>{member.joinedAtLabel ?? 'Not available'}</td>
                    <td>
                      <a href={`/users/${member.userPublicId}`}>Open user</a>
                    </td>
                  </tr>
                ))}
              </tbody>
