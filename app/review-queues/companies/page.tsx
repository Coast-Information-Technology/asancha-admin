...
export default function CompanyReviewQueuePage() {
  ...
  return (
    <ManagementListPage
      ...
      filters={[{ label: 'All companies', href: '/companies' }, { label: 'On hold', href: '/companies?status=on_hold' }, { label: 'Verification review', href: '/companies?verificationStatus=in_review' }]}
      metrics={[{ label: 'Queue records', value: String(companies.length), detail: 'Demo companies requiring review', tone: 'warning' }, { label: 'Verification review', value: '2', detail: 'Company verification active', tone: 'info' }, { label: 'Documents', value: '2', detail: 'Company documents need attention', tone: 'danger' }, { label: 'Ready after review', value: '1', detail: 'Demo approved company outside queue', tone: 'success' }]}
