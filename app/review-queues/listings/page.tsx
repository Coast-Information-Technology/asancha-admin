  ...
  return (
    <ManagementListPage
      ...
      filters={[
        ...
        { label: 'Under review', href: '/listings?status=under_review' },
      ...
      metrics={[
        {
          ...
          detail: 'Demo listings requiring review',
          tone: 'warning',
        },
        { label: 'Review active', value: '2', detail: 'Publication checks active', tone: 'info' },
        { label: 'Reserved', value: '1', detail: 'Connected reservation workflow', tone: 'danger' },
        {
          label: 'Published outside queue',
          value: '1',
          detail: 'Public listing record',
          tone: 'success',
        },
      ]}
