...
export default function VerificationReviewQueuePage() {
  ...
  return (
    <ManagementListPage
      ...
      filters={[{ label: 'All reviews', href: '/verification-reviews' }, { label: 'Pending', href: '/verification-reviews?status=pending' }, { label: 'Correction required', href: '/verification-reviews?status=correction_required' }]}
      metrics={[{ label: 'Queue records', value: String(reviews.length), detail: 'Demo reviews requiring action', tone: 'warning' }, { label: 'High risk', value: '1', detail: 'Priority risk review', tone: 'danger' }, { label: 'Unassigned', value: '1', detail: 'Needs staff assignment', tone: 'info' }, { label: 'Approved outside queue', value: '1', detail: 'Completed verification record', tone: 'success' }]}
