...
export default async function VerificationReviewDetailPage({
  params,
}: VerificationReviewDetailPageProps) {
  ...
  return (
    <ManagementDetailPage
      ...
      links={[
        {
          label: 'Documents',
          href: `/verification-reviews/${review.verificationReviewPublicId}/documents`,
        },
        {
          label: 'Messages',
          href: `/verification-reviews/${review.verificationReviewPublicId}/messages`,
        },
        {
          label: 'Review action',
          href: `/verification-reviews/${review.verificationReviewPublicId}/review`,
        },
        {
          label: 'Audit',
          href: `/verification-reviews/${review.verificationReviewPublicId}/audit`,
        },
    ...
    >
      <section aria-label="Verification review context" className="asancha-card-grid">
        ...
        <MetaCard
          label="High-impact audit actions"
          value={String(review.auditSummary.highImpactActionsCount)}
        />
      </section>

      <Card>
        <CardHeader>
          <CardTitle>Safe review context</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="asancha-cluster">
            ...
            <Badge
              tone={
                review.riskRating === 'high' || review.riskRating === 'critical'
                  ? 'danger'
                  : 'warning'
              }
            >
              Risk: {review.riskRating}
            </Badge>
